    ...
    <div class="container">
        <div class="bg-white rounded">
            <div class="text-center">
                <br />
                <a href="e_create.php" class="btn btn-primary">
                    <h4>
                        成績の登録</h4>
                </a> <br /> <br />
                <form id="student_search_form" method="post" action="e_index.php">
                    <label for="search_name" class="h4">　生徒名:</label>
                    <input type="text" id="search_name" name="name" placeholder="生徒名を入力">

                    <label for="search_number" class="h4">　学籍番号:</label>
                ...
                <?php if ($numResults > 0) { ?>
                    ...
                    foreach ($results as $result) {
                        ...
                        <button class="btn btn-success" data-bs-toggle="modal"
                            data-bs-target="#e_edit_<?php echo $result['exam_id']; ?>">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form id="exam_form_<?php echo $result['exam_id']; ?>" method="post" action="">
                                            ...
                                            国語
                                            <input type="number" name="japanese_<?php echo $result['exam_id']; ?>" min="0"
                                                max="100" value="<?php echo $result['japanese']; ?>"
                                                onchange="calculateTotal(<?php echo $result['exam_id']; ?>)">
                                            数学
                                            <input type="number" name="math_<?php echo $result['exam_id']; ?>" min="0" max="100"
                                                value="<?php echo $result['math'];
                                                ; ?>" onchange="calculateTotal(<?php echo $result['exam_id']; ?>)">
                                            英語
                                            <input type="number" name="english_<?php echo $result['exam_id']; ?>" min="0"
                                                max="100" value="<?php echo $result['english']; ?>"
                                                onchange="calculateTotal(<?php echo $result['exam_id']; ?>)">
                                            理科
                                            <input type="number" name="science_<?php echo $result['exam_id']; ?>" min="0"
                                                max="100" value="<?php echo $result['science']; ?>"
                                                onchange="calculateTotal(<?php echo $result['exam_id']; ?>)">
                                            <br />
                                            社会
                                            <input type="number" name="society_<?php echo $result['exam_id']; ?>" min="0"
                                                max="100" value="<?php echo $result['society']; ?>"
                                                onchange="calculateTotal(<?php echo $result['exam_id']; ?>)">
                                            合計
                                            <input type="number" name="total_<?php echo $result['exam_id']; ?>" min="0"
                                                max="500" value="<?php echo $result['total']; ?>"
                                                id="total_<?php echo $result['exam_id']; ?>" readonly>
                    ...
                    <a href="e_index.php" class="btn btn-primary">
                        <h3>もう一度検索する</h3>
                    </a>
                    <br /> <br />
                <?php } ?>
